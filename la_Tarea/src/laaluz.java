...
class laaluz extends GLJPanel implements GLEventListener, KeyListener {

    private static String TITLE = "Aplicacion de iluminacion chida 2.0";  // window's title
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glClearColor(14.0f, -18.0f, 1.0f, 18.0f); // set background (clear) color
    ...
    public void setSomeMaterial(GL2 gl, int face, float rgba[], int offset) {
        ...
        gl.glMateriali(face, GL2.GL_SHININESS, 2);
...
*/
    ...
    public void setSomeBlueMaterial(GL2 gl, int face) {
        gl.glMaterialfv(face, GL2.GL_AMBIENT, colorGreen, 0);
    ...
    public void drawLight(GL2 gl, GLU glu, GLUT glut) {
        ...
        gl.glPushMatrix();
        {
            ...
            glut.glutSolidSphere(0.7f, 30, 30);
    ...
    public void reshape(GLAutoDrawable glad, int x, int y, int width, int height) {
        ...
        glu.gluPerspective(fovy, aspect, 0.1, 30.0); // fovy, aspect, zNear, zFar
